...
function TarjetaDestino({ destino, opcion }: { destino: Destino; opcion: number }) {
  return (
    <li className="rounded-2xl border border-noche-800 bg-noche-900/40 p-5 transition-colors hover:border-dorado-500/50">
      <p className="font-titulo text-xs tracking-[0.25em] text-dorado-600">
        OPCIÓN {opcion}
      </p>
      <h3 className="mt-2 font-titulo text-2xl tracking-wide text-crema-50">
        {destino.nombre}
      </h3>
